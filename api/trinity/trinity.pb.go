...
func (m *RootConfig) GetNodeRole() string {
	if m != nil {
		return m.NodeRole
	}
	return ""
...
func (m *RootConfig) GetAPIPort() string {
	if m != nil {
		return m.APIPort
	}
	return ""
...
func (m *FIndexConfig) GetMaxSize() uint32 {
	if m != nil {
		return m.MaxSize
	}
	return 0
...
func (m *FIndexConfig) GetStorePath() string {
	if m != nil {
		return m.StorePath
	}
	return ""
...
func (m *IIndexConfig) GetMaxSize() uint32 {
	if m != nil {
		return m.MaxSize
	}
	return 0
...
func (m *IIndexConfig) GetStorePath() string {
	if m != nil {
		return m.StorePath
	}
	return ""
...
func (m *ConfigRequest) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *SetResult) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
type FMValue struct {
	Locations []uint32 `protobuf:"varint,1,rep,packed,name=locations" json:"locations,omitempty"`
}
...
func (m *FMValue) GetLocations() []uint32 {
	if m != nil {
		return m.Locations
	}
	return nil
...
func (m *ForwardMap) GetFindexApiVersion() uint32 {
	if m != nil {
		return m.FindexApiVersion
	}
	return 0
}

func (m *ForwardMap) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *DocStat) GetDocname() string {
	if m != nil {
		return m.Docname
	}
	return ""
...
func (m *DocStat) GetCount() uint32 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *InvertedMap) GetIindexApiVersion() uint32 {
	if m != nil {
		return m.IindexApiVersion
	}
	return 0
}

func (m *InvertedMap) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *FMapRequest) GetDockey() string {
	if m != nil {
		return m.Dockey
	}
	return ""
...
func (m *IMapRequest) GetTermkey() string {
	if m != nil {
		return m.Termkey
	}
	return ""
...
func (m *StartSubsystemRequest) GetSubsystemName() string {
	if m != nil {
...
func (m *StartSubsystemResponse) GetResponseCode() string {
	if m != nil {
...
func (*SearchRequest) Descriptor() ([]byte, []int) { return fileDescriptorTrinity, []int{14} }
...
func (m *SearchResult) GetHash() string {
	if m != nil {
		return m.Hash
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*SearchRequest)(nil), "trinity.SearchRequest")
...
func (c *gatewayClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	...
	err := grpc.Invoke(ctx, "/trinity.Gateway/Search", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trinity.Gateway/Search",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *FMValue) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Locations) > 0 {
		dAtA4 := make([]byte, len(m.Locations)*10)
		var j3 int
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintTrinity(dAtA, i, uint64(j3))
...
func (m *SearchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Id) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTrinity(dAtA, i, uint64(len(m.Id)))
		i += copy(dAtA[i:], m.Id)
	}
	return i, nil
}
...
func (m *FMValue) Size() (n int) {
	...
	if len(m.Locations) > 0 {
		...
		for _, e := range m.Locations {
			l += sovTrinity(uint64(e))
		}
		n += 1 + sovTrinity(uint64(l)) + l
	}
	return n
}
...
var fileDescriptorTrinity = []byte{
	...
	,
}
